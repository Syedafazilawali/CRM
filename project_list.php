...
//					}else
					...
					<tr>
						...
						<td class="text-center">
							<button type="button" class="btn btn-warning btn-sm border-warning wave-effect text-dark dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
		                      Action
		                    </button>
		                    <div class="dropdown-menu" style="">
		                      ...
		                      <?php if($_SESSION['login_type'] == 2 || $_SESSION['login_type'] == 1 || $_SESSION['login_type'] == 3 || $_SESSION['login_type'] == 4): ?>
		                      <a class="dropdown-item" href="./index.php?page=edit_project&id=<?php echo $row['id'] ?>">Edit</a><?php endif; ?>
		                      <div class="dropdown-divider"></div>
						...
						<td><?php echo ucwords($row['wordcount']) ?></td>
