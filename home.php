...
<!-- Info boxes -->
 <div class="col-12">
          <div class="card">
            <div class="card-body">
              Important Announcement! WFH is only allowed when your coordinator permits it based on your work progress.
            </div>
          </div>
  </div>
  <hr>
                  ...
                  <tr>
                      ...
                      <td class="project_progress">
                          <div class="progress progress-sm">
                              <div class="progress-bar bg-yellow" role="progressbar" aria-valuenow="57" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $prog ?>%">
                              </div>
                          </div>
                          <small>
                     ...
                     <td>
    <a class="btnn btn-sm" style="vertical-align: middle;" href="./index.php?page=view_project&id=<?php echo $row['id'] ?>">
        <i class="fas fa-folder" style="vertical-align: middle;"></i> View
    </a>
</td>
